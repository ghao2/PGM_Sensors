...
def calcRegressionMatrix(humidityTrain, temperatureTrain, humidityTest):
    ...
    #returnVarianceMatrix=copy.deepcopy(humidityTest);
...
tempRegMatrix=calcRegressionMatrix(humidity_train_data, temp_train_data, humidity_test_data);
...
for index in range(0,5):
    ...
    returnMAEMatrix, overallError=calMAEMatrix(tempRegMatrix, temp_test_data, sizeOfWindow);
